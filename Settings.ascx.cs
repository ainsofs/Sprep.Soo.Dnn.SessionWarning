...
namespace Sprep.Soo.Dnn.SessionWarning {
    ...
    /// 
    /// Because the control inherits from SessionWarningSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : SessionWarningModuleSettingsBase {
        ...
        public override void LoadSettings() {
            try {
                if (Page.IsPostBack == false) {
                    ...
                    txtSetting1.Text = set.WarningTimeoutInMinutes.ToString();
        ...
        public override void UpdateSettings() {
            try {
                ...
                //module settings
                //modules.UpdateModuleSetting(ModuleId, SettingKeysEnum.WarningTimeoutInMinutes.ToString(), txtSetting1.Text);
                set.WarningTimeoutInMinutes = Convert.ToInt32(txtSetting1.Text);
